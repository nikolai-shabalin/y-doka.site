...
| 3 | 1999 | Добавили регулярные выражения и [try-catch](/posts/js/doka/try-catch) |
| 4 |  | Так и не вышел |
...
ES5 принёс много хорошего и сделал проще работу с AJAX благодаря JSON, но он не был идеальным. У разработчиков было много претензий к нему. [JSON](/posts/js/doka/json)

Одной из таких претензий, например, был так называемый ребайндинг: когда приходилось явно указывать контекст выполнения функций. [Контекст выполнения функций, this](/posts/js/long/function-context)
...
Или то, что объявление функций «поднималось» в начало области видимости. [var/let](/posts/js/doka/var-let)
...
- Стрелочные функции, которые сохраняют контекст сами ([function() { }](/posts/js/doka/function) );
- Синтаксический сахар в виде классов;
- [`const`](/posts/js/doka/const) и [`let`](/posts/js/doka/var-let)
- Аргументы функций по умолчанию;
- Деструктурирование объектов;
- [Импорты и экспорты](/posts/js/long/modules);
- [Промисы](/posts/js/long/promise);
...
[Webpack](https://webpack.js.org), в отличие от Gulp, — это [бандлер](/posts/js/tools/bundlers). Разница между менеджером задач и бандлером в их подходе к задачам.
