...
![схема атаки click jacking](/assets/images/posts/js/web-security/click-jacking.png)
...
Так как данные всё ещё пересылаются, сервер не может _просто так_ оборвать соединение. Но и заняться другими запросами он тоже не может, потому что занят этим.
