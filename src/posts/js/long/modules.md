...
#### Модульные системы, которые использовались до ES-модулей.\_
...
Подробнее о строгом режиме — в статье [Контекст выполнения функций, this](/posts/js/tools/function-context)
...
В браузере модули сами по себе используются пока редко. Сейчас чаще используются [инструменты сборки](/posts/js/tools/bundlers) типа Gulp, Webpack, Parcel, Rollup и другие.
