...
Практически аналогичное предыдущему значение за тем исключением, что снаружи грид-контейнер, созданный с помощью `inline-grid` будет вести себя как строчный элемент.
