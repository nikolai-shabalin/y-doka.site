...
![Принцип комбинации красного, зелёного и синего для получения разных цветов](/assets/images/posts/colors-in-web/RGB.jpg)
...
![Два цвета 2021 года по версии Pantone: серый и жёлтый](/assets/images/posts/colors-in-web/HEX.png)
...
![Параметры в системе HSL](/assets/images/posts/colors-in-web/HSL.png)
