...
![Пример текста под заголовком сайта в поисковой выдаче (сниппет)](/assets/images/posts/meta/_meta_.png)
...
![Пример open graph (OG) разметки](/assets/images/posts/meta/_meta__02.png)
